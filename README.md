# MYSQL-Project-Stock Market Analysis
MYSQL PROJECT of Stock Market Analysis.
This repository is created for my Project Stock Market Analysis which is given by Upgrad.
